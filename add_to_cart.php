...
// Check if product ID is received from GET request
if (isset($_GET['product_id'])) {
    $productID = (int)$_GET['product_id']; // Cast to integer to avoid SQL injection
    ...
    $qty = isset($_GET['quantity']) ? (int)$_GET['quantity'] : 1; // Default to 1 if quantity is not set
