            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <article class="title text-center">
                            <h2 class="title-sec">Products</h2>
                            <p class="sub-title">Latest <i class="uil uil-list-ui-alt"></i><i
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item discount">
                            <div class="product-item-inner">
                                ...
                                <a href="products.php" class="link">
                                    <figure class="img-box">
                                        <img src="assets/img/products/Ore_Quantum_ADG950.090.jpg"
                                            alt="Quantum ADG950.090">
                                    </figure>
                                </a>
                                <div class="details">
                                    <span class="cat"><i class="uil uil-tag-alt"></i> Quantum</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item discount">
                            <div class="product-item-inner">
                                ...
                                <a href="products.php" class="link">
                                    <figure class="img-box">
                                        <img src="assets/img/products/Ore_Quantum_ADG679.990.jpg"
                                            alt="Quantum ADG679.990">
                                    </figure>
                                </a>
                                <div class="details">
                                    <span class="cat"><i class="uil uil-tag-alt"></i> Quantum</span>
